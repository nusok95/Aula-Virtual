...
class WindowRegistryTeacher(QMainWindow):
    def __init__(self):
        super().__init__()
        self.TIPO_USUARIO = 2;
        self.initUI()
    ...
    def initUI(self):
        ...
        self.setWindowTitle('Registro de maestros')
        ...
        # Label matricula
        self.lbl_matricula = QLabel("Número de personal", self)
        self.lbl_matricula.setStyleSheet(
            "font-weight: bold; color: white; font-family: century gothic; font-size: 15px")
        self.lbl_matricula.setMinimumSize(300, 25)
        ...
        # Button to register
        self.btn_registry = QPushButton('Guardar', self)
    ...
    def validar_campos(self):
        return self.txt_name.text() == "" or self.txt_name.text() == None or self.txt_last_name.text() == "" or self.txt_last_name.text() == None \
               or self.txt_last_name_m.text() == "" or self.txt_last_name_m.text() == None \
               or self.txt_matricula.text() == "" or self.txt_matricula.text() == None \
               or self.txt_email.text() == "" or self.txt_email.text() == None \
               or self.txt_password.text() == "" or self.txt_password.text() == None \
               or self.txt_repeat_password.text() == "" or self.txt_repeat_password.text() == None
...
if __name__ == '__main__':
    ...
    windowRegistry = WindowRegistryTeacher()
    sys.exit(app.exec_())
